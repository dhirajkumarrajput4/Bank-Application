 ...
 * @author apptech
 */
public class Cash_Withdrow extends JFrame
{
    ...
    private void Create()
    {
        ...
        btnCancel.setFont(f);
        btnDiposit=new JButton("Withdrow");
             ...
             if(txtAccNo.getText().isEmpty())
            {
            ...
            else
             {
              String acc=txtAccNo.getText();
               ...
               {
                   JOptionPane.showMessageDialog(rootPane,"No Customer Found in database for selected customer ID");
               }
               rs.close();
               }
               catch(SQLException ex)
               {
                    JOptionPane.showMessageDialog(rootPane,"No Customer Found in database for selected customer ID"+ex);
       ...
       btnDiposit.addActionListener(new ActionListener()
       {
           ...
           public void actionPerformed(ActionEvent e)
           {
               ...
               else
               {
                   ...
                   double balance=Double.parseDouble(txtDipoBall.getText());
                   String acNo= txtAccNo.getText();
                   
                   Bank_Database.cashWithdrow(balance,acNo);
                   
                   JOptionPane.showMessageDialog(jop,balance+"rs. is Debeted from your A/C");
