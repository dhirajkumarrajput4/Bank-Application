 ...
 * @author apptech
 */
public class Check_Bal extends JFrame
{
    ...
    private void Create()
    {
        ...
        lbldob.setFont(f);
        lblDipoBall=new JLabel("Account Balance");
        ...
        btnCancel.setFont(f);
        btnDiposit=new JButton("Check Balance");
       ...
       btnDiposit.addActionListener(new ActionListener()
       {
           ...
           public void actionPerformed(ActionEvent e)
           {
               String acNo= txtAccNo.getText();
                 ...
                 rs1=Bank_Database.getBal(acNo);
                 
                     try {
                         if(rs1.next())
                         {
                       txtDipoBall.setText(rs1.getString("AccountBalance"));
                         }
                         else
                         {
                           JOptionPane.showMessageDialog(rootPane,"01 No Customer Found in database for selected customer ID");
                         }
               } catch (SQLException ex) {
                  System.out.println(ex);
                   ...
                   JOptionPane.showMessageDialog(jop,"Thank You For Visiting");
